...
<head>
    ...
    <title>@if(isset($appSettings['institute_settings']['short_name'])){{$appSettings['institute_settings']['short_name']}}@else Sattit Medical College @endif | @yield('pageTitle')</title>
