        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-info">
                    <form novalidate id="reportForm" target="_blank" action="{{URL::Route('report.student_monthly_attendance_details')}}" method="POST" enctype="multipart/form-data">
                        <div class="box-header with-border">
                          <h3 class="box-title">Section wise monthly details attendance</h3>
                        </div>
                        <div class="box-body">
                            @csrf
                            @if(count($errors->all()))
