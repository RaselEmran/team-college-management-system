...
<div id="admit">
 ...
 <table class="bg2">
  ...
  <td> {{$dormInfo->name}} <strong>Dormitory Report</strong></td>
  <td >
...
<table class="bg3">
    ...
    @foreach($students as $data)
        <tr>
            <td>{{$data->registration->regi_no}}</td>
            <td>{{$data->registration->rol_no}}</td>
            <td>{{$data->registration->student->name}}</td>
            <td>{{$data->registration->class->name}}</td>
            <td>{{$data->registration->section->name}}</td>
            <td>{{$data->registration->acYear->title}}</td>
            <td>{{$data->roomNo}}</td>
...
<table>
 <tr>  <td><strong>Total Rooms:</strong></td><td>{{$dormInfo->numOfRoom}}</td><td>&nbsp;&nbsp;</td><td><strong>Total Students:</strong></td><td>{{$students->count()}}</td> <tr>
</table>
<br>
<center>-----0-----</center>
<div id="footer">
