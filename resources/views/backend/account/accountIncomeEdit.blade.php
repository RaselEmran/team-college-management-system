...
<!-- Page title -->
@section('pageTitle') income update @endsection
@section('extraStyle')
 @endsection
<!-- End block -->
...
@section('pageContent')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Income Upadte</li>
        </ol>
    </section>
    <!-- ./Section header -->
    <!-- Main content -->
    ...
    <section class="content">
      <div class="box col-md-12">
        <div class="box-inner">
         @if (isset($income))
                        <form role="form" action="{{ route('accounting.postincomeupdate') }}" method="post">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group ">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" value="{{$income->date}}"  class="form-control datepicker" name="date" required>
                                            </div>
